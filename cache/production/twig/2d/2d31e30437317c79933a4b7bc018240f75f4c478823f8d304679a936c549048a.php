...
/* ucp_header.html */
class __TwigTemplate_63043eb4ec2460c992d7ad5657f928e03fc6bc2995d5d5a08a3b86c6a7a77e28 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
        ...
        // line 16
        echo "
<div class=\"panel bg3 bg-ucp-panel\">
\t<div class=\"inner\">
...
\t\t\t\t\t";
                    ...
                    if (twig_get_attribute($this->env, $this->source, $context["t_block2"], "S_SELECTED", [], "any", false, false, false, 29)) {
                        // line 30
                        echo "\t\t\t\t\t\t<li id=\"active-subsection\" class=\"active-subsection\"><a class=\"hvr-sweep-to-right\" href=\"";
...
\t\t\t\t\t";
                        ...
                        // line 32
                        echo "\t\t\t\t\t\t<li><a class=\"hvr-sweep-to-right\" href=\"";
...
\t\t\t\t";
            // line 91
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, ($context["loops"] ?? null), "pm_colour_info", [], "any", false, false, false, 91));
            foreach ($context['_seq'] as $context["_key"] => $context["pm_colour_info"]) {
                // line 92
                echo "\t\t\t\t\t<dd class=\"pm-legend";
                if (twig_get_attribute($this->env, $this->source, $context["pm_colour_info"], "CLASS", [], "any", false, false, false, 92)) {
                    echo " ";
                    echo twig_get_attribute($this->env, $this->source, $context["pm_colour_info"], "CLASS", [], "any", false, false, false, 92);
                }
                echo "\">";
                if (twig_get_attribute($this->env, $this->source, $context["pm_colour_info"], "IMG", [], "any", false, false, false, 92)) {
                    echo twig_get_attribute($this->env, $this->source, $context["pm_colour_info"], "IMG", [], "any", false, false, false, 92);
                    echo " ";
                }
                echo twig_get_attribute($this->env, $this->source, $context["pm_colour_info"], "LANG", [], "any", false, false, false, 92);
                echo "</dd>
\t\t\t\t";
            }
            $_parent = $context['_parent'];
