...
/* ucp_main_front.html */
class __TwigTemplate_e267472be9aa752eaf7f55b6206795ded4e97b0c6ab0d86fc545eac7edf0bb26 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<div class=\"panel ucp-group-panel\">
\t<div class=\"inner\">
...
";
        ...
        $this->loadTemplate("ucp_footer.html", "ucp_main_front.html", 84)->display($context);
        if ($namespace) {
            $this->env->setNamespaceLookUpOrder($previous_look_up_order);
        }
    }
