...
class phpbb_cache_container extends \Symfony\Component\DependencyInjection\Container
{
    ...
    {
        return $this->services['config'] = new \phpbb\config\db(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['cache.driver']) ? $this->services['cache.driver'] : ($this->services['cache.driver'] = new \phpbb\cache\driver\file())) && false ?: '_'}, 'bb_config');
    }
    ...
    {
        return $this->services['config_text'] = new \phpbb\config\db_text(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'bb_config_text');
    }
    ...
    {
        return $this->services['content.visibility'] = new \phpbb\content_visibility(${($_ = isset($this->services['auth']) ? $this->services['auth'] : ($this->services['auth'] = new \phpbb\auth\auth())) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['dispatcher']) ? $this->services['dispatcher'] : $this->getDispatcherService()) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, './../', 'php', 'bb_forums', 'bb_posts', 'bb_topics', 'bb_users');
    }
    ...
    {
        return $this->services['ext.manager'] = new \phpbb\extension\manager($this, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['filesystem']) ? $this->services['filesystem'] : ($this->services['filesystem'] = new \phpbb\filesystem\filesystem())) && false ?: '_'}, 'bb_ext', './../', 'php', ${($_ = isset($this->services['cache']) ? $this->services['cache'] : $this->getCacheService()) && false ?: '_'});
    }
    ...
    {
        return new \phpbb\notification\method\email(${($_ = isset($this->services['user_loader']) ? $this->services['user_loader'] : $this->getUserLoaderService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, './../', 'php', 'bb_notification_emails');
    }
    ...
    {
        $instance = new \phpbb\notification\type\admin_activate_user(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['language']) ? $this->services['language'] : $this->getLanguageService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['auth']) ? $this->services['auth'] : ($this->services['auth'] = new \phpbb\auth\auth())) && false ?: '_'}, './../', 'php', 'bb_user_notifications');
    ...
    {
        return $this->services['profilefields.lang_helper'] = new \phpbb\profilefields\lang_helper(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'bb_profile_fields_lang');
    }
    ...
    {
        return $this->services['text_formatter.data_access'] = new \phpbb\textformatter\data_access(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'bb_bbcodes', 'bb_smilies', 'bb_styles', 'bb_words', './../styles/');
    }
    ...
    {
        $this->services['text_reparser.forum_description'] = $instance = new \phpbb\textreparser\plugins\forum_description(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'bb_forums');
    ...
    {
        $this->services['text_reparser.forum_rules'] = $instance = new \phpbb\textreparser\plugins\forum_rules(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'bb_forums');
    ...
    {
        $this->services['text_reparser.group_description'] = $instance = new \phpbb\textreparser\plugins\group_description(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'bb_groups');
    ...
    {
        $this->services['text_reparser.pm_text'] = $instance = new \phpbb\textreparser\plugins\pm_text(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'bb_privmsgs');
    ...
    {
        $this->services['text_reparser.poll_option'] = $instance = new \phpbb\textreparser\plugins\poll_option(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'bb_poll_options');
    ...
    {
        $this->services['text_reparser.poll_title'] = $instance = new \phpbb\textreparser\plugins\poll_title(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'bb_topics');
    ...
    {
        $this->services['text_reparser.post_text'] = $instance = new \phpbb\textreparser\plugins\post_text(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'bb_posts');
    ...
    {
        $this->services['text_reparser.user_signature'] = $instance = new \phpbb\textreparser\plugins\user_signature(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'bb_users');
    ...
    {
        return $this->services['user_loader'] = new \phpbb\user_loader(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, './../', 'php', 'bb_users');
    }
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'tables.notification_emails' => 'bb_notification_emails',
            ...
            'tables' => [
                'acl_groups' => 'bb_acl_groups',
                'acl_options' => 'bb_acl_options',
                'acl_roles' => 'bb_acl_roles',
                'acl_roles_data' => 'bb_acl_roles_data',
                'acl_users' => 'bb_acl_users',
                'attachments' => 'bb_attachments',
                'auth_provider_oauth_token_storage' => 'bb_oauth_tokens',
                'auth_provider_oauth_states' => 'bb_oauth_states',
                'auth_provider_oauth_account_assoc' => 'bb_oauth_accounts',
                'banlist' => 'bb_banlist',
                'bbcodes' => 'bb_bbcodes',
                'bookmarks' => 'bb_bookmarks',
                'bots' => 'bb_bots',
                'captcha_qa_questions' => 'bb_captcha_questions',
                'captcha_qa_answers' => 'bb_captcha_answers',
                'captcha_qa_confirm' => 'bb_qa_confirm',
                'config' => 'bb_config',
                'config_text' => 'bb_config_text',
                'confirm' => 'bb_confirm',
                'disallow' => 'bb_disallow',
                'drafts' => 'bb_drafts',
                'ext' => 'bb_ext',
                'extensions' => 'bb_extensions',
                'extension_groups' => 'bb_extension_groups',
                'forums' => 'bb_forums',
                'forums_access' => 'bb_forums_access',
                'forums_track' => 'bb_forums_track',
                'forums_watch' => 'bb_forums_watch',
                'groups' => 'bb_groups',
                'icons' => 'bb_icons',
                'lang' => 'bb_lang',
                'log' => 'bb_log',
                'login_attempts' => 'bb_login_attempts',
                'migrations' => 'bb_migrations',
                'moderator_cache' => 'bb_moderator_cache',
                'modules' => 'bb_modules',
                'notification_emails' => 'bb_notification_emails',
                'notification_types' => 'bb_notification_types',
                'notifications' => 'bb_notifications',
                'poll_options' => 'bb_poll_options',
                'poll_votes' => 'bb_poll_votes',
                'posts' => 'bb_posts',
                'privmsgs' => 'bb_privmsgs',
                'privmsgs_folder' => 'bb_privmsgs_folder',
                'privmsgs_rules' => 'bb_privmsgs_rules',
                'privmsgs_to' => 'bb_privmsgs_to',
                'profile_fields' => 'bb_profile_fields',
                'profile_fields_data' => 'bb_profile_fields_data',
                'profile_fields_options_language' => 'bb_profile_fields_lang',
                'profile_fields_language' => 'bb_profile_lang',
                'ranks' => 'bb_ranks',
                'reports' => 'bb_reports',
                'reports_reasons' => 'bb_reports_reasons',
                'search_results' => 'bb_search_results',
                'search_wordlist' => 'bb_search_wordlist',
                'search_wordmatch' => 'bb_search_wordmatch',
                'sessions' => 'bb_sessions',
                'sessions_keys' => 'bb_sessions_keys',
                'sitelist' => 'bb_sitelist',
                'smilies' => 'bb_smilies',
                'sphinx' => 'bb_sphinx',
                'styles' => 'bb_styles',
                'styles_template' => 'bb_styles_template',
                'styles_template_data' => 'bb_styles_template_data',
                'styles_theme' => 'bb_styles_theme',
                'styles_imageset' => 'bb_styles_imageset',
                'styles_imageset_data' => 'bb_styles_imageset_data',
                'teampage' => 'bb_teampage',
                'topics' => 'bb_topics',
                'topics_posted' => 'bb_topics_posted',
                'topics_track' => 'bb_topics_track',
                'topics_watch' => 'bb_topics_watch',
                'user_group' => 'bb_user_group',
                'user_notifications' => 'bb_user_notifications',
                'users' => 'bb_users',
                'warnings' => 'bb_warnings',
                'words' => 'bb_words',
                'zebra' => 'bb_zebra',
            ],
